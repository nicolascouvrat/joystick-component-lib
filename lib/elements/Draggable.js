...
class Draggable extends React.Component {
  ...
  constructor(props) {
    ...
    // the draggable move
    this._panResponder = this.props.override ?
      this.props.override:
      PanResponder.create({
  ...
  componentWillReceiveProps(newProps) {
    ...
    if (newProps.gesture) {
      ...
      if (newProps.gesture.dx !== this.state.pan.x.__getValue() ||
          newProps.gesture.dy !== this.state.pan.y.__getValue()) {
        this.onTouchMove(newProps.gesture);
      }
    }
  }
